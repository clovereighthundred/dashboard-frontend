        ...
        <div className="bg-white border-r border-border h-screen flex flex-col animate-slide-in">
            ...
            <div className="p-6 border-b border-border">
                <div className="flex items-center justify-between">
                    ...
                    <Button variant="ghost" size="icon" onClick={ () => setIsCollapsed(!isCollapsed)} className="button-press">
                        {isCollapsed ? (
                ...
                <div className="flex items-center gap-3">
                    ...
                    {isCollapsed && (
                        <div className="flex-1 animate-fade-in">
                            ...
                            <p className="text-xs text-muted-foreground">felaadegbokun@gmail.com</p>
                        </div>
                    )}
                </div>
            </div>
